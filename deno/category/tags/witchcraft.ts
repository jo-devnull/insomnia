...
categoryTag(category.witchcraft, {
    title : "Bruxaria",
    icon  : "irons_spellbooks:item/holy_upgrade_orb"
})

tags.item(category.witchcraft, [
...
/// irons_spellbooks ---------------------------------------------
export const irons_spellbooks = tags.item(category.witchcraft, [
    "#curios:ring",
    "#curios:spellbook",
...
/// alexsmobs ---------------------------------------------
export const alexsmobs = tags.item(category.witchcraft, [
